...
copy_root_scripts() {
    ...
    cp "$repo_root/scripts/repo-health-snapshot.sh" "$target/scripts/"
    cp "$repo_root/scripts/performance-budgets.sh" "$target/scripts/"
    cp "$repo_root/scripts/validate-executable-docs.sh" "$target/scripts/"
    ...
    cp "$repo_root/scripts/agent-intents.txt" "$target/scripts/"
