...
require_workflow "fleet" "smu fleet apply --hosts hosts.txt --profile vps --dry-run --parallel 2 --continue-on-error --json"
require_workflow "release-package" "smu release-package --version 1.2.3 --channel latest-known-good --json"
require_workflow "release-package" "smu release-package --version 1.2.3 --channel latest-known-good --output dist/set-me-up-1.2.3 --json"
require_workflow "blueprint-registry" "smu blueprint-registry --json"
require_workflow "blueprint-registry" "smu blueprint-registry --registry-url https://example.com/smu-blueprints.json --json"
